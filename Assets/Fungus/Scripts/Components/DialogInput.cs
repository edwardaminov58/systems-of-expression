    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            case ClickMode.ClickAnywhere:
                if (Input.GetMouseButtonDown(0)||(Input.GetKeyDown(KeyCode.LeftArrow)) || (Input.GetKeyDown(KeyCode.RightArrow)) || (Input.GetKeyDown(KeyCode.UpArrow)) || (Input.GetKeyDown(KeyCode.DownArrow)))
                {
                    SetNextLineFlag();
                }
                break;
